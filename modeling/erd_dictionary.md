...
| | user_email | Электронная почта | Адрес электронной почты для входа и уведомлений | varchar |
| | user_password | Пароль | Пароль пользователя | varchar |
| | user_name | Имя | Имя пользователя | varchar |
